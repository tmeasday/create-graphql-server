...
describe('test-5: user with role "user"', () => {
  ...
  before(function(done) {
      ...
      .then(result => {
        ...
        assert.equal(result.data.createUser.role, 'user');
  ...
  describe('on type "user" (part 1)...', () => {
    ...
    it('admin user created new user "tobkle" with role "user" for the next tests...', () => {
